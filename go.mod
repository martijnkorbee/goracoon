module github.com/martijnkorbee/goracoon

go 1.18

require (
	github.com/CloudyKit/jet/v6 v6.1.0
	github.com/alexedwards/scs/badgerstore v0.0.0-20220528130143-d93ace5be94b
...
require (
	...
	github.com/xhit/go-simple-mail v1.0.0 // indirect
